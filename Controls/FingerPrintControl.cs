    ...
    public partial class FingerPrintControl : UserControl 
    {
        ...
        public  FingerPrintControl()
        {
         ...
         //   pBar.Value = 0;
            ...
            textBox2.TextChanged += new EventHandler(eventH);
            textBox4.TextChanged += new EventHandler(eventH);

            
            //label21.Click += new EventHandler(eventBMI);
        ...
        public void eventH(object sender, EventArgs e)
        {
            button3.PerformClick();
        }
        public void eventBMI(object sender, EventArgs e)
        {

            MessageBox.Show("triigrer");
            try
            {
                double bmi = double.Parse(label21.Text);
                if (bmi < 20)
                {
                    label19.Text = "hhh";
                }
            ...
            catch (Exception e2) { MessageBox.Show("ErroR"); }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                inputH = double.Parse(h);
                inputW = double.Parse(w);
            ...
            try
            {
                ...
                else
                {
                  ...
                  //  MessageBox.Show(this.comboBox2.SelectedText);
                    ...
                    wordDoc.Content.Find.Execute(FindText: "{date}", ReplaceWith: DateTime.Now);
                    wordDoc.Content.Find.Execute(FindText: "{company}", ReplaceWith:label18.Text);
        ...
        class traner
        {
            ...
            public String cID;
            public String img;
            public traner(String a , String b , String c  , String d  , String f , String g , String h  , String i ,String ccompanyID  , string imgg)
       ...
       */
        ...
        {
            // Create a new web request to fetch the image
            var request = WebRequest.Create(url);

            // Get the response from the web request
            using (var response = await request.GetResponseAsync())
            {
                // Get the stream containing the image data
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                        ...
                        
                    {
                        ...
                        */  
                        ...
                        //string[] parts = this.helperList[this.rowCourser].dob.Split(' ');
                     
                        label23.Text = this.helperList[this.rowCourser].dob.Split(' ')[0];
                        
                          

                        try
                        {
                            label18.Text = this.companyDIC[this.helperList[this.rowCourser].cID].ToString();
                        }
                        catch
                        {
                            label18.Text = "Not found";
                        ...
                        try
                        {
                            ...
                            pBar.Visible = true;
                            timer1.Start();
                            await LoadImageAsync("https:" + this.helperList[this.rowCourser].img);
                            //this.pictureBox1.LoadAsync("https:" + this.helperList[this.rowCourser].img);
                        ...
                        try { 
                            ...
                            if (bmi>=25 && bmi < 30)
                            {
                                label19.Text = "overweight";
                                label19.ForeColor = Color.Orange;
                            }
                            if (bmi >= 30)
                            {
                                label19.Text = "Extremely overweight";
                                label19.ForeColor = Color.Red;
                            }
               ...
               */
                    ...
                    {   /*
                        ...
                        */
                        ...
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.served = this.helperList[rowCourser].id.ToString();
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.now = this.helperList[rowCourser+1].id.ToString();
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.next = rowCourser + 2 <this.helperList.Count ?  this.helperList[rowCourser + 2].id : "loading";
                       // MessageBox.Show("DAaa3");
                        this.rowCourser++;
                        return;
                    }
                    if (rowCourser + 2  == this.helperList.Count)
                    {
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.served = this.helperList[rowCourser].id;
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.now = this.helperList[rowCourser + 1 ].id;
                    ...
                    else
                    {
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.served = this.helperList[rowCourser ].id;
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.now = this.helperList[rowCourser + 1].id;
                        ZKTecoFingerPrintScanner_Implementation.Properties.Settings.Default.next = this.helperList[rowCourser + 2].id;
                        this.rowCourser++;
                        //return; 
                    }
            ...
            catch (IndexOutOfRangeException ex )
            {
                ...
                MessageBox.Show("The class over allready plz select new class", e2.Message.ToString() );
       ...
       // comboBox.SelectedIndexChanged += new EventHandler(ComboBox_SelectedIndexChanged);
            ...
            try
            {
              ...
              //  dataGridView1.ClearSelection();
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    try
                    {
                         img = dynamicResult4.response["photo"].ToString(); 
                    }
                    catch (Exception eee ) { }
                    tranersList.Add(new traner(a,b,c,d,ee,f,g,h,companyID , img));
        ...
        public static async Task<string> GetCompanyData()
        {
            ...
            String url = "https://www.tsti.ae/version-live/api/1.1/obj/companies";
                ...
                else
                {
...

                    {
                        ...
                        */
                        ...
                        try
                        {
                           // rowPrevuois = this.rowCourser ;
                            dataGridView1.Rows[this.rowCourser].DefaultCellStyle.BackColor = Color.Red;
                            this.rowCourser --; 
                        }
                        catch (Exception e4) {
                            rowPrevuois = this.rowCourser;
                            MessageBox.Show("you reatch the beging of the list plz click next");
                            this.rowCourser = 0;
